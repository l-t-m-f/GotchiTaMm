...
internal class Subsystem_UI
   {
      ...
      private void Init_Buttons_Subroutine()
         {
            this.Buttons_Dictionary.Add(Button_Name_Type.SELECT, new
               Button(Art_Style_Type.SINGLE_SPRITE, "Button_B",
            ...
            this.Buttons_Dictionary.Add(Button_Name_Type.EXECUTE, new
               Button(Art_Style_Type.SINGLE_SPRITE, "Button_Y",
                  Subsystem_Input.Instance.Select_Button_Pressed,
                  new SDL_Point
                     {
                        x = WINDOW_W / 2,
            ...
            this.Buttons_Dictionary.Add(Button_Name_Type.CANCEL, new
               Button(Art_Style_Type.SINGLE_SPRITE, "Button_R",
                  Subsystem_Input.Instance.Select_Button_Pressed,
                  new SDL_Point
                     {
                        x = WINDOW_W / 5 * 4,
            ...
            for (int i = 0; i < string_pool_len; i++)
               {
                  ...
                  int font_size_fac =
                     Game_String_Pool.Data[i].Size_Factor;
                  IntPtr font_to_use =
                     this.Fonts_Dictionary.GetValueOrDefault(
                        font_name)![
                        font_size_fac];

                  IntPtr test_text = TTF_RenderUTF8_Blended(
                     font_to_use,
      ...
      public void Draw()
         {
            ...
            SDL_Rect close_button_rect = Subsystem_Imaging
               .Instance.Sprite_Atlas
               .Get_Atlas_Image_Rect("Close");
            close_button_rect.w =
               (int)(close_button_rect.w * SCREEN_RATIO);
            close_button_rect.h =
               (int)(close_button_rect.h * SCREEN_RATIO);
            close_button_rect.x = (int)(WINDOW_W *
                                        SCREEN_RATIO) -
                                  close_button_rect.w;
            close_button_rect.y = 1;
            SDL_RenderCopy(Renderer, Subsystem_Imaging
                  .Instance.Sprite_Atlas
                  .Get_Atlas_Image("Close"),
               IntPtr.Zero,
               ref close_button_rect);
            ...
            Util.BlitRect(Renderer, Subsystem_Imaging
               .Instance.Sprite_Atlas
               .Get_Atlas_Image("ButtonSelection"),
                  ...
                  for (int col = 0; col < 4; col++)
                     {
                        ...
                        picto_bg_dest.w =
                           (int)(picto_bg_dest.w * SCREEN_RATIO);
                        picto_bg_dest.h =
                           (int)(picto_bg_dest.h * SCREEN_RATIO);
                        picto_bg_dest.x =
                           (int)(WINDOW_W / 5 * col *
                                 SCREEN_RATIO) + (int)
                           (picto_bg_dest.w
                        ...
                        picto_dest.w =
                           (int)(picto_dest.w * SCREEN_RATIO);
                        picto_dest.h =
                           (int)(picto_dest.h * SCREEN_RATIO);
                        picto_dest.x =
                           (int)(WINDOW_W / 5 * col *
      ...
      private void Set_Text_Var(Text_Var_Name_Type text_var_label,
         ...
         {
            IntPtr texture =
               Subsystem_Imaging.Instance.Create_Text_Texture_Pointer(
                  text,
